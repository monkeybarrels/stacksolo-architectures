...
// Computed-like behavior with watchEffect would be cleaner, but keeping simple
  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleSubmit">
        <div v-if="getDisplayError()" class="rounded-md bg-red-50 p-4">
          <div class="flex">
            ...
            <div class="ml-3">
              <p class="text-sm font-medium text-red-800">{{ getDisplayError() }}</p>
            </div>
          </div>
        </div>
